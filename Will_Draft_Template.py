...
with st.form("rent_template"):
    ...
    candidate_name=st.text_input("Candidate Name", placeholder="Enter the candidate's name.")
    candidate_father_name=st.text_input("Candidate Father Name", placeholder="Enter the candidate's father name.")
    partner_name=st.text_input("Partner Name", placeholder="Enter the partner's name.")
    no_of_child=st.text_input("Number of Children",placeholder="Enter the number of children.")
